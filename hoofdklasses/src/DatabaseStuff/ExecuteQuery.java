...
public class ExecuteQuery {
    ...
    public ArrayList<Appliance> getAlleApparaten(int roomid) throws SQLException {
        ...
        while(rs.next())
        {
            ...
            apparaten.add(new Appliance(ApName, EEC, kwh, roomId));
        }
    ...
    public Person getPerson(String username) throws SQLException {
        ...
        Person persoon = new Person(lijst[0],lijst[1], lijst[2],lijst[3], lijst[4],lijst[5], lijst[6]);
    ...
    public ArrayList<Action> getActions(String query) throws SQLException{
        ...
        while(rs.next())
        {
            ...
            //query toevoegen om option te vinden
            actions.add(new Action(actionDate));
        }
