...
public class ControllerApparatenbeheer implements Initializable {
    ...
    void BtnToevoegen(ActionEvent event) throws SQLException {
        ...
        if(!ControllerApparatenbeheer.isInteger(TekstVeld3.getText(), 10)){
    ...
    public void listviewClick(javafx.scene.input.MouseEvent event) {
        ...
        for (Appliance apparaat: apparatenbeheer.getApparaten()) {
