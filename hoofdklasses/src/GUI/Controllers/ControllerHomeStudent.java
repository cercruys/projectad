...
public class ControllerHomeStudent {
    ...
    void ApparatenbeheerBtnClicked(ActionEvent event) throws Exception {
        ...
        Location location = query.getLocationOfStudent(IngelogdeStudent.getIngelogdeStudent().getUsername());
        if (location == null) {
            root = FXMLLoader.load(getClass().getResource("/GUI/fxml/addLocation.fxml"));
